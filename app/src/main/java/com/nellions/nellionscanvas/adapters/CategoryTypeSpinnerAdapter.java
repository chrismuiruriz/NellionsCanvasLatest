 ...
 */
public class CategoryTypeSpinnerAdapter extends ArrayAdapter<AppModel> {

    public Context context;
    List<AppModel> appModelList;

    public CategoryTypeSpinnerAdapter(Context context, int textViewResourceId, List<AppModel> appModelList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(appModelList.get(position).getCategoryType());
        return label;
    }
